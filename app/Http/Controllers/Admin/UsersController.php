...
class UsersController extends AdminController
{
    ...
    public function __construct(RoleRepository $rol_rep, UserRepository $us_rep)
    {
        $this->us_rep = $us_rep;
    ...
    public function index()
    {
        ...
        $this->title = 'Пользоатели';
        $users = $this->us_rep->get();
        $this->content = view(config('settings.theme') . '.admin.users_content', compact('users'));
    ...
    public function edit(User $user)
    {
        ...
        $this->content = view(config('settings.theme') . '.admin.users_create_content', compact('user', 'roles'))->render();
    ...
    {
        return $this->rol_rep->get(['revert' => 'id']);
    }
}
