                ...
                <table style="width: 100%" cellspacing="0" cellpadding="0">
                    ...
                    @foreach($articles as $article)
                        <tr>
                            ...
                            <td class="align-left">{{str_limit($article->full_text,200)}}</td>
                            <td>
                                @if(isset($article->images->mini))
                                    {!! Html::image(asset(config('settings.theme')).'/images/articles/'.$article->images->mini) !!}
                                @endif
                            </td>
