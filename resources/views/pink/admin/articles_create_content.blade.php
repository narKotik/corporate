    ...
    <div class="hentry group">
        ...
        <ul>
            ...
            <li class="textarea-field">
                ...
                <div class="input-prepend"><span class="add-on"><i class="icon-pencil"></i></span>
                    {!! Form::textarea('full_text', isset($article->full_text) ? $article->full_text  : old('full_text'), ['id'=>'editor2','class' => 'form-control','placeholder'=>'Введите текст страницы']) !!}
                </div>
                <div class="msg-error"></div>
            </li>

            @if(isset($article->images->path))
                <li class="textarea-field">
                    ...
                    {{ Html::image(asset(config('settings.theme')).'/images/articles/'.$article->images->path,'',['style'=>'width:400px']) }}
                    {!! Form::hidden('old_image',$article->images->path) !!}
            ...
            <li class="text-field">
                ...
                <div class="input-prepend">
                    {!! Form::select('category_id', $lists, isset($article->category_id) ? $article->category_id  : '') !!}
                </div>
