...
<div id="slider-cycle" class="slider cycle no-responsive slider_cycle group" style="height:485px;">
    <ul class="slider">
        @foreach($sliderItems as $k => $sliderItem)
            <li>
                <div class="slide-holder" style="background:  url('{{ asset(config('settings.theme')) }}/images/{{$sliderItem->img}}') no-repeat center center" style="height:483px;">
